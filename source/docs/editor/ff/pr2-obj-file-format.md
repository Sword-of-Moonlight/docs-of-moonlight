...
typedef struct
{
    ...
    s16 animSprite;         // Type of attatched sprite. 0xFFFF = None, 0x0B00 = Flame, 0x0C00 = Flame, 0x3200 = light wall, 0x33 = light wall, 0x34 = splash,0x3700 = light wall, 0x3800 = light wall, 0xC401 = flame
    ...
    u8 allowMoveXY;         // No fucking clue, just talking HwitVlf's word for it.
} OBJPR2_ITEM;
